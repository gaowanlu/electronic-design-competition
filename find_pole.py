...
black_threshold=(2, 15, -24, 4, -13, 9)

def find_color_pole(img):
    poleData.flag=0
    pixels_max=0
    #直接找色块  找出像素最多的
    for b in img.find_blobs([black_threshold],pixels_threshold=5,merge=True,margin=50):
        if pixels_max<b.pixels() and b.w()<20 and b.w()*4<b.h():
